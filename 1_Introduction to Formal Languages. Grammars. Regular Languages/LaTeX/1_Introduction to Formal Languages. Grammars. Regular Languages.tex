...
\begin{frame}{Automate finite nedeterministe - Exercițiu}
...
\begin{frame}{Automate finite nedeterministe - Exercițiu}
Construiţi un AFN cu exact trei stări care să accepte propozițiile limbajului definit de expresia regulară:
\newline

\textbf{0*1*0*0}
\newline

Deduceţi AFD echivalent. Alegeți o propoziţie care aparţine limbajului şi scrieţi relaţiile de mişcare care descriu analiza ei, pentru fiecare dintre cele două automate.
\end{frame}
...
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto]
 ...
 \path[->]
	 ...
	 (2) edge [bend left] node [below]	{$\varepsilon$, 1} (0)
;
\end{tikzpicture}
\end{figure}
\end{frame}
...
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto]
  ...
  \node[state,accepting]   	(4)  [right of=3] 			{$E$}; 
 ...
 \path[->]
	 ...
	 (1) edge [bend left] node	{a} (2)
 	 ...
 	 (3) edge [bend left] node	{a, $\varepsilon$} (4)
...
\begin{itemize}
\item
Construiţi o gramatică echivalentă.
\item
